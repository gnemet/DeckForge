...
DeckForge is distributed as a **Single-Binary** with all UI assets (templates, CSS, JS) embedded. We provide four pre-configured versions in our [GitHub Releases](https://github.com/gnemet/DeckForge/releases):
...
## 🏁 Getting Started
1. **Download** the relevant distribution from the [Releases](https://github.com/gnemet/DeckForge/releases) page.
