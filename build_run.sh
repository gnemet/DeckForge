...
# DeckForge Build and Run Script
...
MOUNT_DIR=${STORAGE_REMOTE:-"/home/gnemet/DeckForgeFiles/remote"}
...
# 4. Building DeckForge...
go build -o bin/slideforge ./cmd/server

APP_PORT=${PORT:-8088}
LOG_FILE=${STORAGE_LOG:-"/home/gnemet/DeckForgeFiles/slideforge.log"}

echo "Killing process on port $APP_PORT..."
fuser -k $APP_PORT/tcp 2>/dev/null || true

echo "Starting DeckForge on http://localhost:$APP_PORT (Logs: $LOG_FILE)"
