...
DeckForge follows specific development patterns to ensure rapid iteration and integration with the wider GoBI/Antigravity library ecosystem.

## Workspace Environment

- **Standard Location**: The project is finalized in `/home/gnemet/GitHub/DeckForge`.
...
DeckForge leverages the `datagrid` library as a local replacement to ensure synchronization with the latest UI standards.
...
- **Benefit**: This allows the "Library-First" architecture to flourish, as enhancements in `datagrid` are immediately visible in DeckForge.
