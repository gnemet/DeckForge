# DeckForge Full Functional Test Plan

This document outlines the step-by-step procedures to verify the core functionality of the DeckForge application, covering the end-to-end workflow from file ingestion to slide generation.
...
3.  **Verify Output**:
    ...
    *   "Starting DeckForge on http://localhost:8088"
